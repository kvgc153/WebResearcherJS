...
class WBJS{
  ...
  makeWrapperNode(){
    ...
    wrapperNode.innerHTML= `<div id="tooltip${this.noteID}"> <div class='mover' id="mover${this.noteID}" ><div style="text-align:right"><button title="Remove note" class="btnWBJS btnWBJS-layered-3d--purple" id="closer${this.noteID}">&#10006;</button></div></div></div>`;
